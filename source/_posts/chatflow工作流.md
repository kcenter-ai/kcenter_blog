...
![alt text](/assets/chatflow/image.png)
![alt text](/assets/chatflow/image-1.png)

对话流创建页面点击**确定**添加触发器成功
![alt text](/assets/chatflow/image-2.png)

节点添加执行操作(**基于工作流内置RAG节点**进行操作)，先添加**召回节点**
![alt text](/assets/chatflow/image-3.png)
![alt text](/assets/chatflow/image-6.png)

填写**召回节点**详细设置信息
![alt text](/assets/chatflow/image-7.png)
![alt text](/assets/chatflow/image-8.png)

点击**确定**按钮添加**召回节点**成功
![alt text](/assets/chatflow/image-9.png)

再次添加操作节点**大模型节点**
![alt text](/assets/chatflow/image-10.png)
![alt text](/assets/chatflow/image-11.png)
填写**大模型节点**详细设置，其中base_url和apikey为模型的API访问地址和密钥，此处以deepseek为示例
![alt text](/assets/chatflow/image-12.png)
填写完成节点信息后保存工作流
![alt text](/assets/chatflow/image-13.png)

**至此chatflow对话工作流创建成功**

### 2.创建chatflow对话流智能体
进入智能体创建页面,创建智能体，智能体模式选择**对话流创建**
![alt text](/assets/chatflow/image-14.png)
填写对话流智能体信息，保存智能体
![alt text](/assets/chatflow/image-15.png)

### 3.使用对话流智能体进行问答
输入query和临时区文件
![alt text](/assets/chatflow/image-16.png)

查看chatflow工作流任务运行结果
![alt text](/assets/chatflow/image-17.png)

查看智能体对话输出(**智能体的问答输出结果来源于智能体绑定的工作流的最后一个大模型节点的输出结果**)
![alt text](/assets/chatflow/image-18.png)
